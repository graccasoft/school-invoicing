...
public class InvoiceController {
    ...
    @PostMapping("student")
    public GenericResponse generateStudentInvoice(GenerateStudentInvoiceRequest generateStudentInvoiceRequest){
    ...
    @PostMapping("school")
    public GenericResponse generateSchoolClassInvoice(GenerateSchoolClassInvoiceRequest generateSchoolClassInvoiceRequest){
